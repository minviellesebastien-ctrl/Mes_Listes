// Structure globale stockant les listes et leurs éléments internes
let appData = JSON.parse(localStorage.getItem('appData')) || {
    diverseLists: [
        { id: 1, name: 'Liste Projet' }
    ],
    items: {
        'Repas': ['Lundi: Poulet rôti', 'Mardi: Pâtes carbonara'],
        ...
        'Liste Projet': ['Acheter domaine', 'Faire maquette']
    }
};
...
// Gestion de la Pop-up et des éléments internes
function openModal(title) {
    currentActiveList = title;
    document.getElementById('modalTitleinnerText'] = title;
...
// Importation / Exportation sans émojis
